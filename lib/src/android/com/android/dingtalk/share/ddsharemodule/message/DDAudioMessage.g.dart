...
class com_android_dingtalk_share_ddsharemodule_message_DDAudioMessage extends java_lang_Object with com_android_dingtalk_share_ddsharemodule_message_DDMediaMessage_IMediaObject {
  ...
  Future<void> serialize(android_os_Bundle var1) async {
    ...
    final result = await MethodChannel('com.fluttify/ddshare_fluttify').invokeMethod('com.android.dingtalk.share.ddsharemodule.message.DDAudioMessage::serialize', {"var1": var1.refId, "refId": refId});
  ...
  Future<void> unserialize(android_os_Bundle var1) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/ddshare_fluttify').invokeMethod('com.android.dingtalk.share.ddsharemodule.message.DDAudioMessage::unserialize', {"var1": var1.refId, "refId": refId});
  ...
  Future<int> type() async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/ddshare_fluttify').invokeMethod('com.android.dingtalk.share.ddsharemodule.message.DDAudioMessage::type', {"refId": refId});
  ...
  Future<bool> checkArgs() async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/ddshare_fluttify').invokeMethod('com.android.dingtalk.share.ddsharemodule.message.DDAudioMessage::checkArgs', {"refId": refId});
  ...
  Future<int> getSupportVersion() async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/ddshare_fluttify').invokeMethod('com.android.dingtalk.share.ddsharemodule.message.DDAudioMessage::getSupportVersion', {"refId": refId});
