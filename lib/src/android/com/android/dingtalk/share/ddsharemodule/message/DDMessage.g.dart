...
class com_android_dingtalk_share_ddsharemodule_message_DDMessage
  ...
  static Future<bool> send(
    ...
    if (fluttifyLogEnabled) {
      print(
          'fluttify-dart: com.android.dingtalk.share.ddsharemodule.message.DDMessage::send([\'receiverPermission\':$receiverPermission, \'action\':$action, \'content\':$content])');
    }

    // invoke native method
    final result = await MethodChannel('com.fluttify/ddshare_fluttify')
        .invokeMethod(
            'com.android.dingtalk.share.ddsharemodule.message.DDMessage::send',
            {
