...
Future<dynamic> _handler(MethodCall methodCall) {
  if ("Callback::com.android.dingtalk.share.ddsharemodule.IDDAPIEventHandler::onResp" ==
      methodCall.method) {
    _responseShareController.sink.add(methodCall.arguments);
  }
  return Future.value(true);
}

Future<com_android_dingtalk_share_ddsharemodule_plugin_SignatureCheck>
    createcom_android_dingtalk_share_ddsharemodule_plugin_SignatureCheck__() async {
...
Future<com_android_dingtalk_share_ddsharemodule_plugin_DDVersionCheck>
    createcom_android_dingtalk_share_ddsharemodule_plugin_DDVersionCheck__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_MMessageUtil>
    createcom_android_dingtalk_share_ddsharemodule_MMessageUtil__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDTextMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDTextMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDMediaMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDMediaMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_SendMessageToDD_Resp>
    createcom_android_dingtalk_share_ddsharemodule_message_SendMessageToDD_Resp__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_SendMessageToDD_Req>
    createcom_android_dingtalk_share_ddsharemodule_message_SendMessageToDD_Req__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDMediaMessage_Builder>
    createcom_android_dingtalk_share_ddsharemodule_message_DDMediaMessage_Builder__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_SendAuth>
    createcom_android_dingtalk_share_ddsharemodule_message_SendAuth__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_SendAuth_Resp>
    createcom_android_dingtalk_share_ddsharemodule_message_SendAuth_Resp__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDImageMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDImageMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_SendAuth_Req>
    createcom_android_dingtalk_share_ddsharemodule_message_SendAuth_Req__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDWebpageMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDWebpageMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDZhiFuBaoMesseage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDZhiFuBaoMesseage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDVideoMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDVideoMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDMessageAct>
    createcom_android_dingtalk_share_ddsharemodule_message_DDMessageAct__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDFileMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDFileMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_SendMessageToDD>
    createcom_android_dingtalk_share_ddsharemodule_message_SendMessageToDD__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_message_DDAudioMessage>
    createcom_android_dingtalk_share_ddsharemodule_message_DDAudioMessage__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_algorithm_MD5>
    createcom_android_dingtalk_share_ddsharemodule_algorithm_MD5__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_DDShareApiFactory>
    createcom_android_dingtalk_share_ddsharemodule_DDShareApiFactory__() async {
  final int refId = await _channel.invokeMethod(
...
Future<com_android_dingtalk_share_ddsharemodule_ShareConstant>
    createcom_android_dingtalk_share_ddsharemodule_ShareConstant__() async {
  final int refId = await _channel.invokeMethod(
